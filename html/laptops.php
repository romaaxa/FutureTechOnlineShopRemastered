    ...
    <div id="phones" class="section">
        <div class="container">
            <div class="phones-content">
                <div>
                    <h2><i class="fa fa-apple" area-hidden="true"></i>It's better to invent tomorrow than worry about yesterday being so-so. <br /> <br />
                        <br /> <br /></h2>
                    <p>D5 Conference: All Things Digital (the Fifth annual conference of the newspaper All Things Digital), 2007</p>
                </div>
                <div>
                    <img src="..\images\1stevejobs.jpg" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="sortingblock">
            <ul id="options">
                ...
                <li><a id="selectsorting">None</a>
                    <ul id="sorting-list">
                        <li><a href="laptops.php?sort=price-asc">low cost first</a></li>
                        <li><a href="laptops.php?sort=price-desc">high cost first</a></li>
                    </ul>
            </ul>
        </div>
                ...
                <table>
                    <tr style="align-content: center; text-align: center;">
                        ...
                        if (isset($_POST['submits'])) {
                            $search = $_POST['search'];
                            $query = mysqli_query($connectt, "SELECT * FROM `db_laptop` WHERE `name` LIKE '%$search%'");
                            ...
                            <small style="color: white;">Processor:' . $row["proc"] . '; </small>
                            <small style="color: white;">GraphProcessor:' . $row["graphproc"] . '; </small>
                            <small style="color: white;">Core: ' . $row["cores"] . '; </small>
                            <small style="color: white;">Memory: ' . $row["memory"] . '; </small>
                            <small style="color: white;">Camera: ' . $row["camera"] . '; </small>
                            <small style="color: white;">Video Adapter: ' . $row["video"] . '; </small>
        ...
        <div id="item_box" class="section" style="margin-left: 10px">
            <div class="container">
                <div class="item_box-content">
                    ...
                    $mysqli->query($query);
                    $query = "select * from db_laptop";
                    $results = $mysqli->query("select * from db_laptop ORDER BY $sorting");
