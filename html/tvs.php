    ...
    <div id="phones" class="section">
        <div class="container">
            <div class="phones-content">
                <div>
                    <h2><i class="fa fa-television" aria-hidden="true"></i></i>Immerse yourself in what you see.<br /> <br />
                        <br /> <br /></h2>
                    <p>The modern TV is a piece of furniture added in the Modern Update.
                        The TV system was revamped with the modern TV. Instead of old channels, you can now load and watch GIFs. </p>
                </div>
                <div>
                    <img src="..\images\tvmain.png" alt="">
                </div>
            </div>
        </div>
    </div>
        ...
        <div id="sortingblock">
            <ul id="options">
                ...
                <li><a id="selectsorting">None</a>
                    <ul id="sorting-list">
                        <li><a href="tvs.php?sort=price-asc">low cost first</a></li>
                        <li><a href="tvs.php?sort=price-desc">high cost first</a></li>
                    </ul>
            </ul>
        </div>
                ...
                <table>
                    <tr style="align-content: center; text-align: center;">
                        ...
                        if (isset($_POST['submits'])) {
                            $search = $_POST['search'];
                            $query = mysqli_query($connectt, "SELECT * FROM `db_tv` WHERE `name` LIKE '%$search%'");
                            ...
                            <small style="color: white;">SmartScreen:' . $row["smartscreen"] . ' <br /> </small>
        ...
        <div id="item_box" class="section" style="margin-left: 10px">
            <div class="container">
                <div class="item_box-content">
                    ...
                    $results = $mysqli->query("select * from db_tv ORDER BY $sorting");
